...
export const Sidebar = () => {
  ...
  const aStyle = tw`block py-1 md:my-3 ml-1 align-middle no-underline md:pr-1 text-near-black hover:text-fuschia pb-1 text-xs md:text-base md:inline-block`;
  return (
    <div
